...
class PhotoCredencialScreen extends StatefulWidget {
  ...
  const PhotoCredencialScreen({super.key, required this.onTakePhoto, required this.fromCamera});
      ...
      child:Column(
        ...
        children: [
          photo == null
                ...
                : Image.file(File(photo!.path), width: screenWidth*0.5, height: screenWidth*0.5),
          ...
          Row (
            ...
            children: [
              PhotoButton(funcion: _takePhoto, label: widget.fromCamera ? 'Tomar Foto' : 'Elegir Foto', textColor: Theme.of(context).colorScheme.primary),
              PhotoButton(funcion: () => context.go('/credentials'), label: 'Enviar Foto', color: Theme.of(context).colorScheme.primary, textColor: Theme.of(context).colorScheme.onPrimary,)
            ]
          )
        ]),
      ),
